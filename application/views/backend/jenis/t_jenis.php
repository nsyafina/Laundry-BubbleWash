  ...
  <div class="container-fluid">
    <div class="card shadow mb-4">
      <div class="card-body" style="border: 1px solid rgba(18, 56, 137, 0.4); box-shadow: inset -3px -3px rgba(18, 56, 137, 0.4); border-radius: 10px">
        <form method="post" action="<?= base_url('jenis/simpan') ?>" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="file" style="border: 1px solid rgba(18, 56, 137, 0.6); box-shadow: inset -2px -2px rgba(18, 56, 137, 0.6); border-radius: 10px; height: 45px;" name="gambar" class="form-control" required>
          </div>
          <div class="form-group">
